package com.jusutech.easyshopugserver.Service;
...
import com.jusutech.easyshopugserver.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener{
    ...
    private void showNotification(String key, Request request) {
        ...
        int randomNum = new Random().nextInt(9999-1)+1;
        manager.notify(randomNum,builder.build());
    }
